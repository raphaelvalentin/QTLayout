...
def Bridge4x4c(width1 = 10.0, width2=10.0, width3=10.0, width4=10.0, spacing = 3.01/1.1, vector=None):
    angle = 45.0
    if vector==None:
        vector = Point(0,0)
    #
    ...
    bridge.append( point7r )
    bridge.append( Point(point7r.x+3, point7r.y)  )
    bridge.append( Point(point7r.x+3, point8r.y)  )
    bridge.append( point8r )
