...
material = list()
material.append( Material(name='Aluminum', kappa=3.8528221e+07, tc1=3.85e-3, color=(0.75, 0.75, 0.75)) )
material.append( Material(name='Poly', kappa=0.0873362e+07, tc1=2.10e-3, color=(0.25, 1.0, 0.50)) )
...
material.append( Material(name='AA', kappa=1/(150*0.31e-6), epsilon=11.9, transparency=0.5) )
...
metal.append( Layer(name='AA', material='AA', zmax=0.0, thickness=0.31) )
